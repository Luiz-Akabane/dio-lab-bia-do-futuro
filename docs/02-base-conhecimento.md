...
| Arquivo | Formato | Para que serve no Alfred? |
|---------|---------|---------------------|
...
O produto Fundo Imobiliário (FII) substituiu o Fundo Multimercado, pois pessoalmente me sinto mais confiante em usar apenas produtos financeiros que eu conheço. Assim, poderei validar as respostas do Alfred de forma mais assertiva.
